...
public class QRRSBlock {
    public int totalCount, dataCount;
    ...
    public static QRRSBlock[] getRSBlocks(int typeNumber, QRErrorCorrectLevel errorCorrectLevel){
        ...
        return list.toArray(new QRRSBlock[0]);
    }
